from src.python_imagesearch.imagesearch import *
...
pos = image_search_loop("./github.png", 0.5)
...
pos = image_search_area("./github.png", 0, 0, 800, 600)
if pos[0] != -1:
    print("position : ", pos[0], pos[1])
    pyautogui.moveTo(pos[0], pos[1])
else:
...
time1 = time.clock()
for i in range(10):
    image_search_area("./github.png", 0, 0, 800, 600)
    image_search_area("./panda.png", 0, 0, 800, 600)
...
for i in range(10):
    image_search_area("./github.png", 0, 0, 800, 600, 0.8, im)
    image_search_area("./panda.png", 0, 0, 800, 600, 0.8, im)
...
print(str(image_search_from_folder('./', 0.8)))
